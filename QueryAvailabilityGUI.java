...
//                    Date lastDate=new Date(((java.util.Date)tableModel.getValueAt(i,3)).getTime());
                    Object firstDate =  tableModel.getValueAt(i,2);
                    Object lastDate = tableModel.getValueAt(i,3);
                    Object price =  tableModel.getValueAt(i, 4);
                    String fd = firstDate.toString();
                    String ld = lastDate.toString();
                    String p = price.toString();
                    
                    RuralHouse rh =  (RuralHouse) comboBox.getSelectedItem();
                    Reserva r = new Reserva(rh,fd,ld, p);
                    r.setVisible(true);
                }
            });
